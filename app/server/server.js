 ...
 * 处理react组件所有的静态方法
 * 
 * @param {function} dispatch 触发请求
 * @param {any} components 组件
 * @param {any} params 参数
 * @returns promise
 */
...
app.use(serverRoutes(io))

app.use((req, res, next)=> {
  let url = req.originalUrl
  console.log('是否登录' + req.session.isLogin)
  ...
  return `<!doctype html>
    <html>
      ...
      <body>
        ...
        <script type="text/javascript" charset="utf-8" src="https://cdn.socket.io/socket.io-1.4.5.js"></script>
